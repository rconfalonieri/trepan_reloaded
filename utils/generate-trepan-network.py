...
def main():
    ...
    # HEART DATASET
    # if not os.path.exists('../examples/heart_dataset_example/'):
    #     os.makedirs('../examples/heart_dataset_example')
    # unwanted_columns = []
    # class_name = 'label'
    # class_nr = 2 
    # generate_trepan_network('heart_dataset',';',unwanted_columns,class_name,class_nr)
    # NEURAL NET classification 
    #  TREPAN output is: Decision tree has 82% accuracy with lo_mofn, 76% with m_of_n


    # LOAN DATASET
    # https://www.kaggle.com/hafidhfikri/loan-approval-prediction/notebook
    if not os.path.exists('../examples/loan_dataset_example/'):
        os.makedirs('../examples/loan_dataset_example')
    unwanted_columns = ['Loan_ID']
    class_name = 'Loan_Status'
    class_nr = 2 
    generate_trepan_network('loan_dataset',';',unwanted_columns,class_name,class_nr)
    # NEURAL NET classification 
    #  TREPAN output is: Decision tree has 82% accuracy with lo_mofn, 76% with m_of_n


    # TRANSACTION DATASET - FRAUD DETECTION
    # https://www.kaggle.com/ntnu-testimon/paysim1     
    # unwanted_columns = ['step','nameOrig','nameDest','isFlaggedFraud']
    # class_name = 'isFraud'
    # class_nr = 2 
    # generate_trepan_network('transactions',',',unwanted_columns,class_name,class_nr)
    ...
    # class_name = 'Dataset'
    # class_nr = 2 
    # generate_trepan_network('indian_liver_patient',',',unwanted_columns,class_name,class_nr)
    #  TREPAN output is: Decision tree has 74% accuracy with lo_mofn (high number of nodes), 75% with m_of_n, less nodes
    ...
    # class_name = 'income'
    # class_nr = 2
    # generate_trepan_network('adult',',',unwanted_columns,class_name,class_nr)
    # TREPAN output is: Decision tree has a ridicolous low accuracy (55% with lo_mofn)

    # BIOMEDICAL
    # https://www.kaggle.com/uciml/biomechanical-features-of-orthopedic-patients/version/1#column_3C_weka.csv 
    # Data for classifying patients based on three labels: Hernia, Spondylolisthesis, Normal
    # unwanted_columns = []
    # class_name = 'class'
    # class_nr = 2
    # generate_trepan_network('biomechanical2C',',',unwanted_columns,class_name,class_nr)
    # TREPAN output is: Decision tree has 97% accuracy with lo_mofn, 100% with m_of_n 

    # bank-loan-status-dataset
    # 
    # Data for classifying patients based on three labels: Hernia, Spondylolisthesis, Normal
    # unwanted_columns = ['Loan_ID', 'Customer_ID']
    # class_name = 'Loan_Status'
    # class_nr = 2
    # generate_trepan_network('credit',',',unwanted_columns,class_name,class_nr)
